...
export const ANIMES_DATA = [
    new Anime(1, "title 1", `Some quick example text to build
    on the card title and make up the bulk of the card's content.`,
        "https://static.fnac-static.com/multimedia/Images/FD/Comete/125062/CCP_IMG_ORIGINAL/1631283.jpg"),
    new Anime(2, " Tokyo Revengers", ` Takemichi Hanagaki is a freelancer that's reached the absolute pits of despair in his life.
    ...
    life, Takemichi decides to get revenge on his life FF.`,
        "https://cfm.yidio.com/images/tv/67100/poster-180x270.jpg"), 
        new Anime(1, "title 1", `Some quick example text to build
    on the card title and make up the bulk of the card's content.`,
            "https://static.fnac-static.com/multimedia/Images/FD/Comete/125062/CCP_IMG_ORIGINAL/1631283.jpg"),
             new Anime(1, "title 1", `Some quick example text to build
